                    ...
                    <form action="{{ route('admin.discounts.update', $discount->id) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $discount->name)" required autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="amount" class="block mt-1 w-full" type="number" name="amount" :value="old('amount', $discount->amount)" min="1" max="100" required />
