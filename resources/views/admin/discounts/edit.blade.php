                    ...
                    <form action="{{ route('admin.discounts.update', $discount->id) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="percentage" class="block mt-1 w-full" type="number" name="percentage" :value="old('percentage', $discount->percentage)" min="1" max="100" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="start_date" class="block mt-1 w-full" type="date" name="start_date" :value="old('start_date', $discount->start_date->format('Y-m-d'))" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="end_date" class="block mt-1 w-full" type="date" name="end_date" :value="old('end_date', $discount->end_date->format('Y-m-d'))" required />
                            ...
                            <div>
                                ...
                                <select id="discount_category_id" name="discount_category_id" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}" {{ old('discount_category_id', $discount->discount_category_id) == $category->id ? 'selected' : '' }}>
                                            {{ $category->name }}
                                        </option>
                                    @endforeach
                                </select>
