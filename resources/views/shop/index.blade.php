                ...
                <div class="p-6">
                    <form action="{{ route('shop.index') }}" method="GET" class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                <label for="discount"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Diskon</label>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                @forelse($products as $product)
                    <div
                        ...
                        <div class="p-4">
                            ...
                            <div class="w-full h-48 bg-gray-200 dark:bg-gray-700 rounded-md mb-4 overflow-hidden">
                            ...
                            <div class="mb-2">
                                ...
                                @if ($activeDiscount)
                                    <div class="flex items-center">
                                        ...
                                        <span
                                            class="ml-2 text-xs font-semibold text-white bg-red-500 px-2 py-1 rounded">
                ...
                @empty
                    <div class="col-span-full text-center py-12">
                        ...
                        <h3 class="mt-2 text-lg font-medium text-gray-900 dark:text-gray-100">Tidak ada produk ditemukan
                        </h3>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Coba ubah filter pencarian Anda.</p>
                    </div>
                @endforelse
            </div>
